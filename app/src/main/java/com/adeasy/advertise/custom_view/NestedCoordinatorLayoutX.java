 ...
 * Email manukayasas99@gmail.com
 **/
public class NestedCoordinatorLayoutX extends CoordinatorLayout implements NestedScrollingChild {

    private NestedScrollingChildHelper mChildHelper;

    public NestedCoordinatorLayoutX(@NonNull Context context) {
        super(context);
        mChildHelper = new NestedScrollingChildHelper(this);
        setNestedScrollingEnabled(true);
    }

    public NestedCoordinatorLayoutX(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mChildHelper = new NestedScrollingChildHelper(this);
        setNestedScrollingEnabled(true);
    }

    public NestedCoordinatorLayoutX(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
