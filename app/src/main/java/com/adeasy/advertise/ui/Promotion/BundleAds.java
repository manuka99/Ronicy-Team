 ...
 * Use the {@link BundleAds#newInstance} factory method to
 * create an instance of this fragment.
 */
public class BundleAds extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment BundleAds.
     */
    // TODO: Rename and change types and number of parameters
    public static BundleAds newInstance(String param1, String param2) {
        BundleAds fragment = new BundleAds();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.manuka_fragment_bundle_ads, container, false);
    ...
    public void onStart() {
        ...
        promotionsViewModel.getOnFragmentSelected().observe(this, new Observer<Fragment>() {
            ...
            public void onChanged(Fragment fragment) {
                if (fragment instanceof BundleAds == false) {
                    radioGroup.setVisibility(View.GONE);
                }
            }
        });
    ...
    private void upDateActivity() {
        ...
        if (isChecked) {
            ...
            promos.put(Promotion.BUNDLE_AD, daysSelected);
