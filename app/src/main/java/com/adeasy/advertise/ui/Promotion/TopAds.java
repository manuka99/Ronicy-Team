 ...
 * Use the {@link TopAds#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TopAds extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment TopAds.
     */
    // TODO: Rename and change types and number of parameters
    public static TopAds newInstance(String param1, String param2) {
        TopAds fragment = new TopAds();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.manuka_fragment_top_ads, container, false);
    ...
    private void toggleCheckBox() {
        if (isChecked) {
            ...
            promotionsViewModel.setOnFragmentSelected(new TopAds());
        }
        upDateActivity();
    }
    ...
    public void onStart() {
        ...
        promotionsViewModel.getOnFragmentSelected().observe(this, new Observer<Fragment>() {
            ...
            public void onChanged(Fragment fragment) {
                if (fragment instanceof TopAds == false) {
                    radioGroup.setVisibility(View.GONE);
                }
            }
        });
    ...
    private void upDateActivity() {
        ...
        if (isChecked) {
            ...
            promos.put(Promotion.TOP_AD, daysSelected);
